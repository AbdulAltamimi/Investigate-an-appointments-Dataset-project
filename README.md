...
This project explores what factors influence a patient’s likelihood to **attend or miss** their medical appointment, focusing on relationships between characteristics like **age**, **gender**, and **health conditions**.
...
- Female diabetic patients slightly outnumber male diabetic patients (~2% difference).  
  <img width="556" height="486" alt="Diabetes by Gender" src="https://github.com/user-attachments/assets/8a205c1d-b45e-4dc1-bf5d-3a33149880f6" />

- About **81.7%** of diabetic patients also have hypertension — a strong correlation between the two diseases.  
  <img width="593" height="407" alt="Diabetes and Hypertension" src="https://github.com/user-attachments/assets/97b878d5-d128-4061-b024-ffb21dc8f7ae" />

- Most diabetic patients fall between **ages 50 and 75**.  
  <img width="557" height="525" alt="Diabetes Age Distribution" src="https://github.com/user-attachments/assets/3bcfb776-9dbf-4a8f-85a9-795285cfb481" />
  <img width="577" height="451" alt="Diabetes Age Histogram" src="https://github.com/user-attachments/assets/afaaa554-7fe5-40e6-a25f-37067ae7668d" />
...
- Patients who **received SMS reminders were more likely to miss** their appointments.  
  <img width="736" height="407" alt="Attendance by SMS" src="https://github.com/user-attachments/assets/77b65b5a-7bd7-4e70-99eb-690155f80c03" />
  <img width="656" height="404" alt="Attendance by SMS Comparison" src="https://github.com/user-attachments/assets/7a3dcc34-c642-4289-8a88-9b5df12bc2e2" />

- Patients **without scholarships** were **more likely to attend** than those with scholarships.  
  <img width="753" height="404" alt="Attendance by Scholarship (No)" src="https://github.com/user-attachments/assets/de2bc1b2-f00c-4450-8cf6-54473cf9203b" />
  <img width="712" height="408" alt="Attendance by Scholarship (Yes)" src="https://github.com/user-attachments/assets/1de85b67-7912-4f38-bafa-9fb9b3fd6184" />

- The **lowest attendance rate** was among patients who had both a scholarship **and** received an SMS reminder.  
  <img width="608" height="539" alt="Attendance Combined Factors" src="https://github.com/user-attachments/assets/6458a560-da48-4ed5-8c95-40593f5bd0f0" />
...
1. **For diabetic patients:**  
   Older age (50–75) and hypertension are strong indicators of diabetes.  

2. **For attendance behavior:**  
   Contrary to expectations, SMS reminders and scholarship programs correlate with *lower* attendance rates.  
   This may reflect issues with SMS content/timing or socioeconomic factors affecting scholarship recipients.
